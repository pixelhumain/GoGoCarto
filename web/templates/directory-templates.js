...
biopen_twigJs_elementInfo.prototype.render_ = function(sb, context, blocks) {
    ...
    // line 104
    sb.append("        <span class=\"col s12 adresse\">");
    sb.append(twig.filter.escape(this.env_, twig.filter.capitalize(this.env_, twig.attr(("element" in context ? context["element"] : null), "adresse")), "html", null, true));
    sb.append("<\/span>\n        \n        ");
    // line 107
    sb.append("        ");
