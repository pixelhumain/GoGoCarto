        ...
        $formMapper
            ->tab('Style')   
                ...
                ->with('Autres couleurs', array('class' => 'col-md-12'))
                    ->add('headerColor', 'text', array('label' => 'Couleur fond header (=text par défault)', 'attr' => ['class' => 'gogo-color-picker'], 'required' => false))
                    ->add('headerTextColor', 'text', array('label' => 'Couleur texte header (=blanc par défault)', 'attr' => ['class' => 'gogo-color-picker'], 'required' => false))
