 ...
 * @ORM\Entity(repositoryClass="Biopen\ElementBundle\Repository\ElementRepository")
 */
class Element
{
    /**
    ...
    /**
    * @ORM\OneToMany(targetEntity="Biopen\ElementBundle\Entity\ElementProduct", mappedBy="element", cascade={"persist", "remove"}, orphanRemoval=true)
    */
    private $products; 
     ...
     * Add product
     *
     * @param \Biopen\ElementBundle\Entity\ElementProduct $product
     *
     * @return Element
     */
    public function addProduct(\Biopen\ElementBundle\Entity\ElementProduct $product)
    {
     ...
     * @param \Biopen\ElementBundle\Entity\ElementProduct $product
     */
    public function removeProduct(\Biopen\ElementBundle\Entity\ElementProduct $product)
    {
